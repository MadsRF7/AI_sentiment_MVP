import uuid
from sqlalchemy import func # Import func for using SQL functions like now() in the model
...
# Method to create a new analysis run record in the database with the provided details
    def create_run(self, original_file_name, total_rows, valid_comment_rows, file_hash=None):
        run = AnalysisRun(
